 ...
 * because that message carries the delivery code they will be asked for. Every
 * other state reaches them on the tracking page, which is open in front of them.
 *
...
const AUDIENCES = {
  ...
  // THE CUSTOMER ONLY, for the delivery code. The Partner just pressed accept
  // and is looking at the job; the store's next action is unchanged by who is
  // coming for it, and it used to be told anyway.
