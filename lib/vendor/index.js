 ...
 *
 * ONE CALL FOR THREE ACTS because they are one fact — can a customer order this
 * right now — plus a reason. The reason is what makes reopening the store clear
 * sold-out marks and leave withdrawn ones alone: running out of jollof is a
 * fact about a service, and taking a dish off the menu is a decision.
 */
export function setMenuItemAvailable(menuItemId, available, reason = 'SOLD_OUT') {
