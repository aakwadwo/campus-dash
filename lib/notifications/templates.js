...
export const SMS_TEMPLATES = {
  ...
  // THE CUSTOMER ONLY, and only because this message carries the code they will
  ...
  [E.PARTNER_ASSIGNED]: {
    ...
    [A.CUSTOMER]: (c) =>
      `Campus Dash: ${c.partnerName} has accepted order #${c.orderNumber}. Your code is ${c.deliveryCode}. Give it to them on arrival.`,
  },
