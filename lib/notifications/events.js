...
export const NOTIFICATION_EVENT = Object.freeze({
  ...
  // THE STORE WOULD NOT HONOUR A MEAL SCAN. Its own event rather than a
  // flavour of ORDER_CANCELLED, because what the customer has to do about it is
  // completely different: the order is over, the money is not coming back, and
  // the way forward is a new order with a scan that works.
