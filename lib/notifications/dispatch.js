 ...
 *
 * Falls back to the production origin so a message is never sent containing the
 * word "null". PUBLIC_APP_URL is what makes it right on a preview deployment.
 */
function appUrl() {
  return config.publicAppUrl() ?? 'https://campus-dash-nine.vercel.app';
}
