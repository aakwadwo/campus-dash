...
const PATTERNS = [
  ...
  {
    match:
      /starting price|price step|maximum price must be|at least one price|at most 20 prices|each price can be listed once/i,
    kind: ERROR_KIND.USER,
    message:
      'Check the prices: a starting price, a step, and a maximum that the steps reach — or a short list of prices, each once.',
  },
