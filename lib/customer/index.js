...
/**
 * Student onboarding. This is what grants the CUSTOMER capability.
 *
 ...
 * to attach to.
 *
 * Nothing here creates an account. The account already exists — a phone was
 * verified to get this far — so this only ever adds a capability to the auth
 * user id already in the session.
 */
