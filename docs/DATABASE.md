...
| `customer_profiles`   | **The CUSTOMER capability.** A row here IS the capability — there is no flag. Student ID number (unique) and level, written only by `complete_customer_onboarding()`. No document: no review ever consumed one. Admin and vendor accounts do not get one automatically.                                                                                                                                                                                                                      |
...
| `order_secrets`       | Pickup and delivery codes, four digits each, plus the failed-attempt counters and lockouts that make four digits safe. **No policy and no grant for anyone.**                                                                                                                                                                                                                                                                                                                                |
